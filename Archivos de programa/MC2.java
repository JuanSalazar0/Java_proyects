...
import java.awt.*;
public class MC2 extends JFrame implements ActionListener{
	...
	public MC2(){
        ...
        textareaDescri = new JTextArea("Descripcion:Green day presentando su conciero\nCrismas in quarentine y su nuevo album");
