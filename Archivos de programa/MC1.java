...
import java.awt.*;
public class MC1 extends JFrame implements ActionListener{
	...
	public MC1(){
        ...
        lugar = new JLabel("->Lugar:Museo Giorno Giovana");
        ...
        textareaDescri = new JTextArea("Descripcion:Un fabuloso evento de Musica clasica donde\nse interpretara Bethoven de las manos de Hideo Kojima");
        ...
        /////////////////////////tuneado/////////////////
        ImageIcon M2 = new ImageIcon("M1.png");
		M22 = new JLabel(M2);
