...
import java.awt.*;
public class MT1 extends JFrame implements ActionListener{
	...
	public MT1(){
        ...
        textareaDescri = new JTextArea("Descripcion:esta es una obra de suspenso que relaciona muchos generos en una sola obra\nel papel protagonico lo tiene Criss Pat");
        ...
        /////////////////////////tuneado/////////////////
        ImageIcon M2 = new ImageIcon("g.png");
		M22 = new JLabel(M2);
