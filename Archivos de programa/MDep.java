...
import java.awt.*;
public class MDep extends JFrame implements ActionListener{
	...
	public MDep(){
		...
		setTitle("Conor McGregor vs Khabib Nurmagomedov");
        //fin de inicio//
        ...
        textareaDescri = new JTextArea("Descripcion:Este es de las peleas mas esperadas del MMA\nQuien se alzara como el campeon?");
        ...
        /////////////////////////tuneado/////////////////
        ImageIcon M2 = new ImageIcon("Pelea.jpg");
		M22 = new JLabel(M2);
	...
	public void actionPerformed(ActionEvent accion){
		if(accion.getSource() == compra){
            CompraMDep gold = new CompraMDep();
